...
![语言支持](https://qiniu.84dd.xyz/python/sb_tool_build.png)
...
```
![查找python](https://qiniu.84dd.xyz/python/type_a_python.png)
...
```
![查找python](https://qiniu.84dd.xyz/python/echo_path_python.png)
...
![编译](https://qiniu.84dd.xyz/python/sb_build.png!84dd)
...
![Atom](https://qiniu.84dd.xyz/python/atom.png!84dd)
